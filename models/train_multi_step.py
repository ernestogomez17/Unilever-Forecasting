...
def main(runid):
    ...
    # TODO load the adjacency matrix from the data and remove self-loop
    ...
    vmae, vmape, vrmse, vmse = metric(pred,realy)
    log = 'valid mean valid MAE: {:.4f}, valid MSE: {:.4f}, valid r2: {:.4f}'
    print(log.format( vmae, vmape, vrmse, vmse))
    ...
    for i in range(args.seq_out_len):
        ...
        log = 'Evaluate best model on test data for horizon {:d}, Test MAE: {:.4f}, Test MAPE: {:.4f}, Test RMSE: {:.4f}, Test MSE: {:.4f}'
    ...
    test_mae, test_mse, test_r2 = np.mean(mae, 0), np.mean(mse, 0), np.mean(rmse, 0)
    log = 'test mean Test MAE: {:.4f}, Test MSE: {:.4f}, Test r2: {:.4f}'
    print(log.format( test_mae, test_mse, test_r2))
